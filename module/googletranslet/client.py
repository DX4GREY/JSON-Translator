...
from googletranslet import urls, utils
from googletranslet.gtoken import TokenAcquirer
from googletranslet.constants import (
    DEFAULT_CLIENT_SERVICE_URLS,
    DEFAULT_FALLBACK_SERVICE_URLS,
    DEFAULT_USER_AGENT, LANGCODES, LANGUAGES, SPECIAL_CASES,
    DEFAULT_RAISE_EXCEPTION, DUMMY_DATA
)
from googletranslet.models import Translated, Detected, TranslatedPart
...
class Translator:
    ...
    def translate_legacy(self, text, dest='en', src='auto', **kwargs):
        ...
        :param dest: The language to translate the source text into.
                     The value should be one of the language codes listed in :const:`googletranslet.LANGUAGES`
                     or one of the language names listed in :const:`googletranslet.LANGCODES`.
